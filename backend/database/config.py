...
class DatabaseConfig:
    ...
    variables via python-dotenv. Falls back to safe defaults
    ...
    name: str = field(default_factory=lambda: os.getenv("DB_NAME", "business_dev"))
    user: str = field(default_factory=lambda: os.getenv("DB_USER", "root"))
    password: str = field(default_factory=lambda: os.getenv("DB_PASSWORD", ""))
    pool_name: str = field(default_factory=lambda: os.getenv("DB_POOL_NAME", "bizdev_pool"))
